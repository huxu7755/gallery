...
class TinyGardenTask @Inject constructor() : CustomTask {
  ...
  override val task =
    Task(
      ...
      labelRes = R.string.task_tiny_garden_label,
      descriptionRes = R.string.task_tiny_garden_description,
      shortDescriptionRes = R.string.task_tiny_garden_short_description,
