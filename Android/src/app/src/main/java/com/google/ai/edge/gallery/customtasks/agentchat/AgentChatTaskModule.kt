...
class AgentChatTask @Inject constructor() : CustomTask {
  ...
  override val task: Task =
    Task(
      ...
      labelRes = R.string.task_agent_skills_label,
      category = Category.LLM,
      iconVectorResourceId = R.drawable.agent,
      newFeature = true,
      models = mutableListOf(),
      descriptionRes = R.string.task_agent_skills_description,
      shortDescriptionRes = R.string.task_agent_skills_short_description,
